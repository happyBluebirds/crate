...
public class ContextPreparer extends AbstractComponent {
    ...
    private static class PreparerContext {
        ...
        BatchConsumer getConsumer(UpstreamPhase phase, int pageSize) {
            ...
            BatchConsumer targetConsumer = consumersByPhaseId.get(phaseIdKey);

            if (targetConsumer != null) {
                // targetConsumer is available because of same node optimization or direct result;
