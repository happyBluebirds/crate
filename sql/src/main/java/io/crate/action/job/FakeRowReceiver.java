...
/**
 * Dummy RowReceiver that must not be used directly. But as {@link BatchConsumer} using {@link #asConsumer()}
 *
 * This is temporary until {@link RowReceiver} is removed.
 */
public class FakeRowReceiver implements RowReceiver {

    private final BatchConsumer batchConsumer;
    private final CompletableFuture<Void> completionFuture = new CompletableFuture<>();

    FakeRowReceiver(BatchConsumer batchConsumer) {
