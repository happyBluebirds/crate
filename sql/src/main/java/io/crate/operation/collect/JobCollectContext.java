...
import io.crate.action.job.BatchConsumerRowReceiverAdapter;
...
import io.crate.operation.join.ListenableBatchConsumer;
...
public class JobCollectContext extends AbstractExecutionSubContext {
    ...
    public JobCollectContext(final CollectPhase collectPhase,
        ...
        this.consumer.completionFuture().whenComplete((r, f) -> close(f));
    ...
    public void innerPrepare() throws Exception {
        collectors = collectOperation.createCollectors(collectPhase, new BatchConsumerRowReceiverAdapter(consumer), this);
    }
