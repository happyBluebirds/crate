...
import io.crate.operation.ListenableBatchConsumer;
...
public class JobCollectContext extends AbstractExecutionSubContext {
    ...
    public JobCollectContext(final CollectPhase collectPhase,
        ...
        this.consumer = new ListenableBatchConsumer(batchConsumer);
        consumer.completionFuture().whenComplete((result, ex) -> close(ex));
