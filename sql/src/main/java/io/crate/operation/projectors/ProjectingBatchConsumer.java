...
public class ProjectingBatchConsumer implements BatchConsumer {
    ...
    public static BatchConsumer create(BatchConsumer delegate,
        ...
        return new ProjectingBatchConsumer(delegate, projections, jobId, ramAccountingContext, projectorFactory);
    }

    public ProjectingBatchConsumer(BatchConsumer delegate,
                                   Collection<? extends Projection> projections,
                                   UUID jobId,
                                   RamAccountingContext ramAccountingContext,
                                   ProjectorFactory projectorFactory) {
