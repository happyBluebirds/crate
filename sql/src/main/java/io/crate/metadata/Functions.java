...
public class Functions {
    ...
    public FunctionImplementation get(FunctionIdent ident) throws IllegalArgumentException {
        return get(ident.schema(), ident.name(), ident.argumentTypes());
    }
     ...
     */
    @Nullable
    public FunctionImplementation get(String schema, String name, List<DataType> arguments)
        throws IllegalArgumentException {
        // built-in functions
        if (Schemas.DEFAULT_SCHEMA_NAME.equals(schema)) {
    ...
    public FunctionImplementation getSafe(FunctionIdent ident) {
        return getSafe(ident.schema(), ident.name(), ident.argumentTypes());
    }
     ...
     * @throws UnsupportedOperationException if no implementation is found.
     */
    public FunctionImplementation getSafe(String schema, String name, List<DataType> arguments)
        ...
        if (implementation == null) {
            if (exceptionMessage == null) {
                exceptionMessage = String.format(Locale.ENGLISH, "unknown function: %s.%s(%s)", schema, name,
